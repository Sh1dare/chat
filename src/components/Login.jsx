    ...
    return (
        <section className="flex flex-col justify-center items-center h-[100vh] background-image">
            <div className="bg-white shadow-lg p-5 rounded-xl h-[27rem] w-[20rem] flex flex-col justify-center items-center">
                <div className="mb-10">
                    <h1 className="text-center text-[28px] font-bold">Войти</h1>
                    <p className="text-center text-sm text-gray-400">Добро пожаловать, войдите чтобы продолжить</p>
                </div>
                ...
                <div className="mt-5 text-center text-gray-400 text-sm">
                    <button onClick={() => setIsLogin(!isLogin)}>Еще нет аккаунта? Зарегистрируйтесь!</button>
                </div>
            </div>
        </section>
    );
